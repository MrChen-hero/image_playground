...
/** API 支持的最大参考图数量 */
const API_MAX_IMAGES = MAX_REFERENCE_IMAGES
...
export default function InputBar() {
  ...
  const qualityOptions = getQualityOptionsForProvider(activeProvider)
  ...
  const handleReplaceFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      replaceInputImage(targetIdx, { id: image.id, dataUrl: image.dataUrl })
